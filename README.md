...
3. Запуск сервера: Откройте файл Start_Server.lnk и дождитесь окончания процесса загрузки мира в консоли.
5. Подключение к игре: Запустите клиент Minecraft и подключитесь к серверу по адресу localhost.
7. Запуск игрового скрипта:
  3. Установите зависимости: pip install -r requirements.txt
  6. Запустите скрипт: python race.py
